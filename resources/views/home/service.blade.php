<section class="homeService container mt-5">
    <h2 class="text-label mb-3">Услуги</h2>
    <div class="cardSwiper swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="cardSwiper__card"
                ...
                >
                    ...
                    <div class="cardSwiper__text">Подбор репетитора</div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="cardSwiper__card"
                ...
                >
                    ...
                    <div class="cardSwiper__text">Проведение МК</div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="cardSwiper__card"
                ...
                >
                    ...
                    <div class="cardSwiper__text">Организация фотосессий</div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="cardSwiper__card"
