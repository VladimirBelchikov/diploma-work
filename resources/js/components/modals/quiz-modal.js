...
function init() {
    ...
    const questionsObj = {
        ...
        couch: [
            { question: 'Какое направление вас интересует?', answers: ['Рисунок', 'Живопись', 'Композиция'] },
        ...
        exhibition: [
            { question: 'Сколько работ планируется?', answers: ['Менее 15', '15-30', '30-50', 'Более 50'] },
            { question: 'Сколько людей планируется на открытии?', answers: ['До 10', '10-20', 'Более 20'] },
            { question: 'Зал с какими стенами вам предпочтительнее?', answers: ['Темные', 'Светлые'] },
        ]
    }
